...
<script type="text/javascript"
        src="https://maps.google.com/maps/api/js?sensor=false&libraries=geometry&key=AIzaSyCQq_d3bPGfsIAlenXUG5RtZsKZKzOmrMw"></script>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(function () {
            ...
            jQuery("#change_language")
                .iconselectmenu({
                    icons: {button: "ui-icon-circle-triangle"},
...
//tooltip enable
        ...
        jQuery('#country').change(function () {
            let region = jQuery('#region');
            let currentCountry = jQuery('#country').val();
            region.empty()

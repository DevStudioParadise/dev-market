	...
	<ul class="shopping-cart-items" >
		...
		<li>
			...
			<div class="item-thumb">
				<a href="javascript:void(0)" class="icon" onClick="delete_cart_product({{$cart_data->customers_basket_id}})"><img class="img-fluid" src="{{asset('').'images/close.png'}}" alt="icon"></a>
				<div class="image">

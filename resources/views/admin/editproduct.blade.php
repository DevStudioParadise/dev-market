                              ...
                              <hr>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="products_contact_<?=$languages->languages_id?>" class="form-control field-validate" value='{{$description_data['products_contact']}}'>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="products_phone_<?=$languages->languages_id?>" class="form-control field-validate" value='{{$description_data['products_phone']}}'>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">

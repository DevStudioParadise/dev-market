                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_1">
                          ...
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown dropdown-main">
                                ...
                                <a href="" class="nav-link " id="navbarDropdownMenuLink00" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-align-right" aria-hidden="true"></i>@lang('website.All Categories')  <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">          
                                @foreach($result['commonContent']['categories'] as $categories_data)            
                                    <li>                
                                        <a class="dropdown-item" href="{{ URL::to('/shop')}}?category={{$categories_data->slug}}"><img class="img-fuild" src="{{asset('').$categories_data->icon}}">{{$categories_data->name}} 
                                         @if(count($categories_data->sub_categories)>0)
                                        ...
                                        <ul class="dropdown-menu dropdown-submenu">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="{{ URL::to('/shop')}}?category={{$sub_categories_data->sub_slug}}"><img class="img-fuild" src="{{asset('').$sub_categories_data->sub_icon}}">{{$sub_categories_data->sub_name}}</a></li>
                                            @endforeach 
                                        </ul>
                                    @endif
                                    </li>
                                    ...
                                    @if($result['commonContent']['recentProducts']['success']==1)
                                        ...
                                        @foreach($result['commonContent']['recentProducts']['product_data'] as $key=>$products)
                                            <div class="carousel-item @if($key==0) active @endif">
                                                ...
                                                <a href="{{ URL::to('/product-detail/'.$products->products_slug)}}" class="fa fa-eye"><img src="{{asset('').$products->products_image}}" alt="{{$products->products_name}}"></a>
                                                ...
                                                <div class="block">
                                                    ...
                                                    <div class="buttons">
                                                        <button  class="btn btn-secondary cart" products_id="{{$products->products_id}}">@lang('website.Add to Cart')</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- End Item -->

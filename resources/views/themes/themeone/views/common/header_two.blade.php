<header id="header-area" class="header-area bg-primary" style="z-index: 999999">
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_0">
                            <ul class="navbar-nav">
                                ...
                                @if (Auth::guard('customer')->check())
                                    <li class="nav-item">
                                        <div class="nav-link">
                                            <span class="p-pic"><img
                                                        src="{{asset('').auth()->guard('customer')->user()->customers_picture}}"
                                                        alt="image"></span>@lang('website.Welcome')
                                            &nbsp;{{ auth()->guard('customer')->user()->customers_firstname }}
                                            &nbsp;{{ auth()->guard('customer')->user()->customers_lastname }}!
                                        </div>
                                    </li>
                                    <li class="nav-item"><a href="{{ URL::to('/profile')}}"
                                                            class="nav-link -before">@lang('website.Profile')</a></li>
                                    <li class="nav-item"><a href="{{ URL::to('/wishlist')}}"
                                                            class="nav-link -before">@lang('website.Wishlist')</a></li>
                                    <li class="nav-item"><a href="{{ URL::to('/orders')}}"
                                                            class="nav-link -before">@lang('website.Orders')</a></li>

                                    <li class="nav-item"><a href="{{ URL::to('/shipping-address')}}"
                                                            class="nav-link -before">@lang('website.Shipping Address')</a>
                                    </li>
                                    <li class="nav-item"><a href="{{ URL::to('/logout')}}"
                                                            class="nav-link -before">@lang('website.Logout')</a></li>
                                @else
                                    <li class="nav-item">
                                        <div class="nav-link">@lang('website.Welcome Guest!')</div>
                                    </li>
                                    <li class="nav-item"><a href="{{ URL::to('/login')}}" class="nav-link -before"><i
                                                    class="fa fa-lock"
                                                    aria-hidden="true"></i>&nbsp;@lang('website.Login/Register')</a>
                                    </li>
                                @endif
                ...
                <div class="col-12  col-sm-12 col-lg-3 spaceright-0">
                    <a href="{{ URL::to('/')}}" class="logo">
                        ...
                        @if($result['commonContent']['setting'][78]->value=='logo')
                            <img src="{{asset('').$result['commonContent']['setting'][15]->value}}"
                    ...
                    <form class="form-inline" action="{{ URL::to('/shop')}}" method="get">
                        <div class="search-categories">
                            ...
                            <input type="search" name="search"
                                   placeholder="@lang('website.Search entire store here')..."
                ...
                <div class="col-12">
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_1">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown dropdown-main">
                                    ...
                                    <a href="" class="nav-link " id="navbarDropdownMenuLink00" data-toggle="dropdown"
                                       aria-haspopup="true" aria-expanded="false"> <i class="fa fa-align-right"
                                                                                      aria-hidden="true"></i>@lang('website.All Categories')
                                        ...
                                        @foreach($result['commonContent']['categories'] as $categories_data)
                                            <li>
                                                <a class="dropdown-item"
                                                   href="{{ URL::to('/shop')}}?category={{$categories_data->slug}}"><img
                                                            class="img-fuild"
                                                            src="{{asset('').$categories_data->icon}}">{{$categories_data->name}}
                                                    @if(count($categories_data->sub_categories)>0)
                                                        <i class="fa fa-angle-right " aria-hidden="true"></i>
                                                    @endif
                                                </a> @if(count($categories_data->sub_categories)>0)
                                                    ...
                                                    <ul class="dropdown-menu dropdown-submenu">
                                                        @foreach($categories_data->sub_categories as $sub_categories_data)
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                   href="{{ URL::to('/shop')}}?category={{$sub_categories_data->sub_slug}}"><img
                                                                            class="img-fuild"
                                                                            src="{{asset('').$sub_categories_data->sub_icon}}">{{$sub_categories_data->sub_name}}
                                                                </a></li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                            ...
                            <!--<li class="nav-item dropdown open">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ URL::to('/shop')}}">@lang('website.Shop')</a></li>
                                <li class="nav-item dropdown open">
                                    <a class="nav-link dropdown-toggle"
                                       href="{{ URL::to('/news/')}}">@lang('website.News')</a>

                                    <ul class="dropdown-menu">
                                        @foreach($result['commonContent']['newsCategories'] as $categories)
                                            <li>
                                                <a class="dropdown-item"
                                                   href="{{ URL::to('/news?category='.$categories->slug)}}">{{$categories->name}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="nav-item dropdown open">
                                    <a href="" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink02"
                                       data-toggle="dropdown" aria-haspopup="true"
                                       aria-expanded="false">@lang('website.infoPages')</a>

                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink02">
                                        @if(count($result['commonContent']['pages']))
                                            @foreach($result['commonContent']['pages'] as $page)
                                                <li><a class="dropdown-item"
                                                       href="{{ URL::to('/page?name='.$page->slug)}}">{{$page->name}}</a>
                                                </li>
                                            @endforeach
                                        @endif
                                    </ul>
                                ...
                                <li class="nav-item last"><a
                                            class="nav-link"><span>@lang('website.hotline')</span>({{$result['commonContent']['setting'][11]->value}}
                                        )</a></li>
                            </ul>
                        </div>
                    </nav>
                    ...
                    <nav id="navbar_2" class="navbar navbar-expand-lg navbar-dark navbar-2 p-0 d-block d-lg-none">
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                                data-target="#navbar_collapse_2" aria-controls="navbar_collapse_2" aria-expanded="false"
                                aria-label="Toggle navigation"> @lang('website.Menu') </button>

                        <div class="collapse navbar-collapse" id="navbar_collapse_2">

                            <ul class="navbar-nav">
                                <li class="nav-item first"><a href="{{ URL::to('/')}}" class="nav-link"><i
...
-->
                                                        ...
                                                        <div class="carousel-inner">
                                                            ...
                                                            @foreach($result['commonContent']['recentProducts']['product_data'] as $key=>$products)
                                                                <div class="carousel-item @if($key==0) active @endif">
                                                                    <span products_id='{{$products->products_id}}'
                                                                          class="fa @if($products->isLiked==1) fa-heart @else fa-heart-o @endif is_liked"><span
                                                                                class="badge badge-secondary">2</span></span>
                                            ...
                                            @foreach($result['commonContent']['categories'] as $categories_data)
                                                ...
                                                <ul class="col-sm-4">
                                                    ...
                                                    <li class="dropdown-header"><a
                                                                href="{{ URL::to('/shop')}}?category={{$categories_data->slug}}">{{$categories_data->name}}</a>
                                                    </li>
                                                    @if(count($categories_data->sub_categories)>0)
                                                        @foreach($categories_data->sub_categories as $sub_categories_data)
                                                            <li>
                                                                <a href="{{ URL::to('/shop')}}?category={{$sub_categories_data->sub_slug}}">{{$sub_categories_data->sub_name}}</a>
                                                            </li>
                                                        @endforeach
                                                    @endif
                                ...
                                <li class="nav-item dropdown open">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if(count($result['commonContent']['pages']))
                                            @foreach($result['commonContent']['pages'] as $page)
                                                <li><a href="{{ URL::to('/page?name='.$page->slug)}}"
                                                       class="dropdown-item">{{$page->name}}</a></li>
                                            @endforeach
                                        @endif
                                    </ul>
                                </li>
